...
import com.example.book.callback.SizeCallBack;
...
public class MenuHorizontalScrollView extends HorizontalScrollView {
	...
	/*扩展宽度*/
	private final int ENLARGE_WIDTH = 40;
...
//	public void initViews(View[] children, SizeCallBack sizeCallBack, LinearLayout ll_menu){
...
//	}
	...
	public void initViews(View[] children, SizeCallBack sizeCallBack, LinearLayout ll_menu){
	 ...
	 public void clickMenuBtn(){
		 ...
		 if(!this.menuOut){
			 ...
			 this.menuWidth = this.ll_menu.getMeasuredWidth() - this.menuBtn.getMeasuredWidth() - this.ENLARGE_WIDTH;
		 }
		 menuSlide();
	 }
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		...
		if(l < (this.ll_menu.getMeasuredWidth() - this.menuBtn.getMeasuredWidth() - this.ENLARGE_WIDTH) / 2){
			this.menuWidth = 0;
		}
		else if(l > 3*(this.ll_menu.getMeasuredWidth() - this.menuBtn.getMeasuredWidth() - this.ENLARGE_WIDTH) / 4){
			
		}
		else{
			this.menuWidth = this.ll_menu.getWidth() - this.menuBtn.getMeasuredWidth() - this.ENLARGE_WIDTH;
		}
		this.current = l;
	}
